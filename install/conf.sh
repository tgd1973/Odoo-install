...
OE_VERSION="16.0"  ##|_______________________________________________________________________________
OS_VERSREPO="False" #| #Set TRUE for odoo14 if you want to install odoo14 from REPO _________________
OE_INSTALL_DIR="$OE_HOME/$OE_VERSION"
OE_REPO="$OE_INSTALL_DIR/odoo"
#Set to true if you want to install it, false if you don't need it or have it already installed.
INSTALL_WKHTMLTOPDF="True" #_________________________________________________________________________
OE_PORT="8069"
OE_NETRPC_PORT="8070"
OE_LONGPOOL_PORT="8072"
OE_WORKERS="4"
#Choose the Odoo version which you want to install. For example: 9.0, 8.0, 7.0 or saas-6. 
...
IS_ENTERPRISE="False" # _____________________________________________________________________________
#set the superadmin password
OE_SUPERADMIN="admin" # _____________________________________________________________________________

INSTALL_PG_SERVER="True" # if false, than only client will be installed______________________________
...
WEB_SERVER="nginx" # or "apache2" or "False" if false, the proxy does not install____________________

HTTP_PROTOCOL="https"
HTTPS_PORT="443"
INSTALL_CERTIFICATE="false" #________________________________________________________________________
